...
namespace FreightManagement.ViewModels
{
    public class CarrierViewModel
    {
        ...
        [Display(Name = "Endereço"), Required(ErrorMessage = "Campo {0} é obrigatório.")]
        [StringLength(150, MinimumLength = 5, ErrorMessage = "Endereço deve ter entre 5 e 150 caracteres")]
